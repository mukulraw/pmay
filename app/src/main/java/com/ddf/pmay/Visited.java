...
public class Visited extends Fragment {
    ...
    public void onResume() {
        ...
        Call<List<jobListBean>> call = cr.visitedList(SharePreferenceUtils.getInstance().getString("id") , lat , lon);
    ...
    class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            ...
            View view = null;
            if (inflater != null) {
                view = inflater.inflate(R.layout.visited_list_model, viewGroup, false);
            }
